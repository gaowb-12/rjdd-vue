<template>
    <div class="spread_content invite">
		...
		<div class="ba_4" @click="handleShare">
			<!-- <a href="https://rjddresw.mypep.cn/rjdianduclient/jfbc/rjdiandu_jfbc.apk" class="ba_xiazai"></a> -->
		</div>
		<!-- 错误提示 -->
		...
		handleShare(){
            ...
            if(isAndroid){
                ...
                if(ua.match(/MicroMessenger/i) == 'micromessenger'){  // 判断不是微信浏览器
                    ...
                    window.location.href="https://rjddresw.mypep.cn/rjdianduclient/jfbc/rjdiandu_jfbc.apk";
                }
            }
        },
        closeLayer(){
